...
void CreateBSpline(vector<glm::vec3*>* points) {
	...
	//	float inc = static_cast<float>(i) / 99.0;
	//	for (int t = 0; t <= 1; t += inc) {
	//		GLfloat x = (((-1 * pow(t, 3) + 3 * pow(t, 2) - 3 * t + 1) * temp->at(i)->x + (3 * pow(t, 3) - 6 * pow(t, 2) + 0 * t + 4) * temp->at(i + 1 % N)->x +  (-3 * pow(t, 3) + 3 * pow(t, 2) + 3 * t + 1) * temp->at(i + 2 % N)->x + (1 * pow(t, 3) + 0 * pow(t, 2) + 0 * t + 0) * temp->at(i + 3 % N)->x) / 6);
	//		GLfloat y = (((-1 * pow(t, 3) + 3 * pow(t, 2) - 3 * t + 1) * temp->at(i)->y + (3 * pow(t, 3) - 6 * pow(t, 2) + 0 * t + 4) * temp->at(i + 1 % N)->y + (-3 * pow(t, 3) + 3 * pow(t, 2) + 3 * t + 1) * temp->at(i + 2 % N)->y + (1 * pow(t, 3) + 0 * pow(t, 2) + 0 * t + 0) * temp->at(i + 3 % N)->y) / 6);
	//		GLfloat z = (((-1 * pow(t, 3) + 3 * pow(t, 2) - 3 * t + 1) * temp->at(i)->z + (3 * pow(t, 3) - 6 * pow(t, 2) + 0 * t + 4) * temp->at(i + 1 % N)->z + (-3 * pow(t, 3) + 3 * pow(t, 2) + 3 * t + 1) * temp->at(i + 2 % N)->z + (1 * pow(t, 3) + 0 * pow(t, 2) + 0 * t + 0) * temp->at(i + 3 % N)->z) / 6);
	//		bSplineCurve.push_back(x);
	//		bSplineCurve.push_back(y);
	//		bSplineCurve.push_back(z);
	//	}
	...
	for (int i = 0; i < (temp->size() - 3); i++) {
		...
		for (int j = 0; j < 100; ++j) {
			...
			GLfloat x = (((-1 * pow(t, 3) + 3 * pow(t, 2) - 3 * t + 1) * temp->at(i)->x + (3 * pow(t, 3) - 6 * pow(t, 2) + 0 * t + 4) * temp->at(i + 1)->x + (-3 * pow(t, 3) + 3 * pow(t, 2) + 3 * t + 1) * temp->at(i + 2)->x + (1 * pow(t, 3) + 0 * pow(t, 2) + 0 * t + 0) * temp->at(i + 3)->x) / 6);
			GLfloat y = (((-1 * pow(t, 3) + 3 * pow(t, 2) - 3 * t + 1) * temp->at(i)->y + (3 * pow(t, 3) - 6 * pow(t, 2) + 0 * t + 4) * temp->at(i + 1)->y + (-3 * pow(t, 3) + 3 * pow(t, 2) + 3 * t + 1) * temp->at(i + 2)->y + (1 * pow(t, 3) + 0 * pow(t, 2) + 0 * t + 0) * temp->at(i + 3)->y) / 6);
			GLfloat z = (((-1 * pow(t, 3) + 3 * pow(t, 2) - 3 * t + 1) * temp->at(i)->z + (3 * pow(t, 3) - 6 * pow(t, 2) + 0 * t + 4) * temp->at(i + 1)->z + (-3 * pow(t, 3) + 3 * pow(t, 2) + 3 * t + 1) * temp->at(i + 2)->z + (1 * pow(t, 3) + 0 * pow(t, 2) + 0 * t + 0) * temp->at(i + 3)->z) / 6);
			bSplineCurve.push_back(x);
			bSplineCurve.push_back(y);
			bSplineCurve.push_back(z);
